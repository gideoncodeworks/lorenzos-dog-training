        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Get in <span className="text-[#C76B45]">Touch</span>
            </h1>
      ...
      <section className="py-24 bg-[linear-gradient(180deg,#fbf8f3_0%,#f4eee6_100%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl font-bold text-[#1B2A23] mb-6">Send Us a Message</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1B2A23] mb-6">Contact Information</h2>
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#eadfce] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  <div className="w-12 h-12 bg-[#C76B45]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <Phone className="w-6 h-6 text-[#C76B45]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#1B2A23] mb-1">Phone</h3>
                    <a href="tel:8664364959" className="text-[#C76B45] hover:text-[#E6B866] font-medium transition-colors">(866) 436-4959</a>
                ...
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#eadfce] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  <div className="w-12 h-12 bg-[#C76B45]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-6 h-6 text-[#C76B45]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#1B2A23] mb-1">Headquarters</h3>
                ...
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#eadfce] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  <div className="w-12 h-12 bg-[#C76B45]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <Mail className="w-6 h-6 text-[#C76B45]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#1B2A23] mb-1">Email</h3>
                    <a href="mailto:info@lorenzosdogtrainingteam.com" className="text-[#C76B45] hover:text-[#E6B866] font-medium transition-colors">info@lorenzosdogtrainingteam.com</a>
                  </div>
                </div>

                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#eadfce] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  <div className="w-12 h-12 bg-[#C76B45]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <Clock className="w-6 h-6 text-[#C76B45]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#1B2A23] mb-1">Service Areas</h3>
              ...
              <div>
                <h3 className="font-semibold text-[#1B2A23] mb-4">Follow Us</h3>
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/lorenzosdogtrainingteam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1B2A23] rounded-2xl flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on Instagram">
                  ...
                  <a href="https://www.facebook.com/LorenzosDogTrainingTeam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1B2A23] rounded-2xl flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on Facebook">
                  ...
                  <a href="https://www.youtube.com/user/mydogtrainingteam" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1B2A23] rounded-2xl flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on YouTube">
