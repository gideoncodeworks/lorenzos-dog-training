            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <a href="tel:8664364959" className="text-[#B8860B] hover:text-[#DAA520] font-medium transition-colors">(866) 436-4959</a>
                ...
                <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a1a2e] mb-1">Headquarters</h3>
                ...
                <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@lorenzosdogtrainingteam.com" className="text-[#B8860B] hover:text-[#DAA520] font-medium transition-colors">info@lorenzosdogtrainingteam.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1a1a2e] mb-1">Service Areas</h3>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/lorenzosdogtrainingteam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1a1a2e] rounded-xl flex items-center justify-center hover:bg-[#B8860B] transition-colors" aria-label="Follow us on Instagram">
                  ...
                  <a href="https://www.facebook.com/LorenzosDogTrainingTeam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1a1a2e] rounded-xl flex items-center justify-center hover:bg-[#B8860B] transition-colors" aria-label="Follow us on Facebook">
                  ...
                  <a href="https://www.youtube.com/user/mydogtrainingteam" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1a1a2e] rounded-xl flex items-center justify-center hover:bg-[#B8860B] transition-colors" aria-label="Follow us on YouTube">
