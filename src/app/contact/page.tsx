      ...
      <section className="section-padding bg-white">
        <div className="container-site">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              <h2 className="text-2xl font-bold text-[#091353] mb-4">Send Us a Message</h2>
            ...
            <div>
              ...
              <div className="space-y-4 mb-10">
                ...
                <div className="card flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@lorenzosdogtrainingteam.com" className="text-[#C8102E] font-medium">info@lorenzosdogtrainingteam.com</a>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/lorenzosdogtrainingteam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#091353] rounded-lg flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on Instagram">
                  ...
                  <a href="https://www.facebook.com/LorenzosDogTrainingTeam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#091353] rounded-lg flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on Facebook">
                  ...
                  <a href="https://www.youtube.com/user/mydogtrainingteam" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#091353] rounded-lg flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on YouTube">
