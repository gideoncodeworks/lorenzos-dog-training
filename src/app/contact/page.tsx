          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#e5e7eb] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  <div className="w-12 h-12 bg-[#C8102E]/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <Phone className="w-6 h-6 text-[#C8102E]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#091353] mb-1">Phone</h3>
                    <a href="tel:8664364959" className="text-[#C8102E] hover:text-[#C8102E] font-medium transition-colors">(866) 436-4959</a>
                ...
                <div className="flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#e5e7eb] shadow-[0_18px_45px_-35px_rgba(27,42,35,0.5)]">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@lorenzosdogtrainingteam.com" className="text-[#C8102E] hover:text-[#C8102E] font-medium transition-colors">info@lorenzosdogtrainingteam.com</a>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/lorenzosdogtrainingteam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#091353] rounded-2xl flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on Instagram">
                  ...
                  <a href="https://www.facebook.com/LorenzosDogTrainingTeam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#091353] rounded-2xl flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on Facebook">
                  ...
                  <a href="https://www.youtube.com/user/mydogtrainingteam" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#091353] rounded-2xl flex items-center justify-center hover:bg-[#C8102E] transition-colors" aria-label="Follow us on YouTube">
