...
const trainers = [
  { name: "Shavon Striggles", city: "Atlanta, GA" },
  { name: "Christopher Almonte", city: "Atlanta, GA" },
  { name: "Robert Wesling", city: "Atlanta, GA" },
  { name: "Chloe Chislom", city: "Atlanta, GA" },
];
      ...
      <section className="bg-[#1a1a2e] pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Dog Training in <span className="text-[#B8860B]">Georgia</span></h1>
