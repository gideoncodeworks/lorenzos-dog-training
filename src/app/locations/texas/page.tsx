    ...
    <>
      <section className="relative bg-[#060D3A] pt-36 pb-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">Dog Training in <span className="text-[#C8102E]">Texas</span></h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#091353] mb-12">Meet Our Texas <span className="text-[#C8102E]">Trainers</span></h2>
