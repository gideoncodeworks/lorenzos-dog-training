...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center pt-28 pb-20">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#091353]/90 via-[#091353]/75 to-[#091353]/50" />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            <p className="text-white/80 text-sm font-medium uppercase tracking-widest mb-4">Trusted Since 1987</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-[#C8102E] hover:bg-[#A00D24] text-white px-8 py-4 rounded-md text-base font-semibold transition-colors"
              >
                Get Started Today
              ...
              <a
                href="tel:8664364959"
                className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm border border-white/25 hover:bg-white/20 text-white px-8 py-4 rounded-md text-base font-semibold transition-colors"
              >
      ...
      {/* Stats */}
      <section className="bg-[#091353] py-10">
      ...
      <section className="py-24 bg-white" id="about-preview">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider mb-3">Our Story</p>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#091353] mb-6 leading-tight">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 bg-[#091353] hover:bg-[#060D3A] text-white px-6 py-3 rounded-md font-semibold transition-colors"
              >
                Read Our Full Story
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#C8102E] text-white p-6 rounded-lg shadow-xl">
      ...
      {/* Services */}
      <section className="py-24 bg-[#F5F7FA]" id="services-preview">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider mb-3">What We Offer</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#091353] mb-4">
          ...
          <div className="text-center mt-12">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 bg-[#091353] hover:bg-[#060D3A] text-white px-8 py-4 rounded-md font-semibold transition-colors"
            >
              View All Services
              <ArrowRight className="w-5 h-5" />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative aspect-square rounded-lg overflow-hidden mt-8 shadow-md">
                <Image
      ...
      {/* Locations */}
      <section className="py-24 bg-[#091353]" id="locations-preview">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider mb-3">Nationwide Coverage</p>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#C8102E]/20 rounded-md flex items-center justify-center">
                  ...
                  <span className="text-xs bg-white/10 text-blue-200/80 px-3 py-1 rounded-full font-medium">
                    {loc.trainers} trainers
                  </span>
                </div>
                <p className="text-blue-200/60 text-sm mb-4">{loc.cities}</p>
                <span className="text-[#C8102E] text-sm font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
                  View Trainers <ArrowRight className="w-4 h-4" />
                </span>
              </Link>
            ))}
            <div className="bg-white/5 border border-white/10 rounded-lg p-8 flex flex-col items-center justify-center text-center">
              <p className="text-white font-bold text-lg mb-2">+ 6 More States</p>
              <p className="text-blue-200/60 text-sm mb-1">Indiana, Kansas, Kentucky</p>
              <p className="text-blue-200/60 text-sm">Massachusetts, Michigan, New Hampshire</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-[#C8102E] font-semibold text-sm uppercase tracking-wider mb-3">Testimonials</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#091353] mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={testimonial.name} className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="font-semibold text-[#091353]">{testimonial.name}</p>
      ...
      <section className="relative py-24">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-[#C8102E] hover:bg-[#A00D24] text-white px-10 py-4 rounded-md text-lg font-semibold transition-colors"
            >
            ...
            <a
              href="tel:8664364959"
              className="inline-flex items-center justify-center gap-2 bg-white/10 border border-white/25 hover:bg-white/20 text-white px-10 py-4 rounded-md text-lg font-semibold transition-colors"
            >
              <Phone className="w-5 h-5" />
              Call Now
            </a>
