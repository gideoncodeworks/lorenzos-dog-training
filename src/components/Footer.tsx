...
export default function Footer() {
  return (
    <footer className="bg-[linear-gradient(160deg,#121A15_0%,#1B2A23_55%,#121A15_100%)] text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/lorenzosdogtrainingteam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on Instagram">
              ...
              <a href="https://www.facebook.com/LorenzosDogTrainingTeam/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on Facebook">
              ...
              <a href="https://www.youtube.com/user/mydogtrainingteam" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#C76B45] transition-colors" aria-label="Follow us on YouTube">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-sm hover:text-[#E6B866] transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#C76B45] flex-shrink-0 mt-0.5" />
                <span className="text-sm">4805 Orchard Rd.<br />Garfield Heights, OH 44128</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-[#C76B45] flex-shrink-0" />
                <a href="tel:8664364959" className="text-sm hover:text-[#E6B866] transition-colors">(866) 436-4959</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-[#C76B45] flex-shrink-0" />
                <a href="mailto:info@lorenzosdogtrainingteam.com" className="text-sm hover:text-[#E6B866] transition-colors">info@lorenzosdogtrainingteam.com</a>
              </li>
            </ul>
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {locationLinks.map((loc) => (
                  <Link key={loc.name} href={loc.href} className="text-xs bg-white/5 hover:bg-[#C76B45]/20 px-3 py-1.5 rounded-full transition-colors hover:text-[#E6B866]">
                    {loc.name}
                  </Link>
                ))}
              </div>
